<x-app-layout>
    <div class="p-4 max-w-5xl mx-auto">
            ...
            <h1 class="bg-gray-100 w-full text-3xl p-2 mb-4 text-center">Student Details</h1>

            <div class="flex flex-wrap justify-center items-center sm:px-48">

                <!-- Profile Picture -->
                <div class="flex flex-col p-4 text-center">
                    <img class="w-36 h-36 rounded-full object-cover mb-4" src="{{ asset('assets/student_profile_pictures/' . $student->profile_picture) }}" alt="Profile Picture">
                ...
                <div class="flex-1 max-w-2xl p-6">
                    <ul class="list-none space-y-4">
                        ...
                        <li><strong class="font-semibold text-black">Contact Number:</strong> {{ $student->contact_number }}</li>
                        <li><strong class="font-semibold text-black">Email:</strong> {{ $student->email }}</li>
                        <li><strong class="font-semibold text-black">Present Qualification:</strong> {{ $student->present_qualification }}</li>
                        <li><strong class="font-semibold text-black">Father's Name:</strong> {{ $student->father_name }}</li>
                        <li><strong class="font-semibold text-black">Mother's Name:</strong> {{ $student->mother_name }}</li>
                        <li><strong class="font-semibold text-black">Profession:</strong> {{ $student->profession }}</li>
                        <li><strong class="font-semibold text-black">Parents' Phone Number:</strong> {{ $student->parents_phone_number }}</li>
                        <li><strong class="font-semibold text-black">Enrollment Date:</strong> {{ $student->enrollment_date }}</li>
                    </ul>
                </div>
